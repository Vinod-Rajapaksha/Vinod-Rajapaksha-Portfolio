...
import { highlights, achievementsStory } from "../../data/achievements";
...
const Achievements = () => {
  ...
  return (
    <section id="achievements" className="scroll-mt-20 bg-slate-950 text-slate-100 py-20 relative overflow-hidden">
      {/* Glow */}
