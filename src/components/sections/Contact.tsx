...
const Contact = () => {
  ...
  <section
    ref={sectionRef}
    id="contact"
    className="scroll-mt-20 bg-slate-950 text-slate-100 py-20 relative overflow-hidden"
  >
    ...
    <motion.div
      ...
      animate={sectionInView ? "animate" : undefined}
            ...
            {contactMethods.map((contact, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  animate={sectionInView ? { x: [0, 4, 0] } : undefined}
